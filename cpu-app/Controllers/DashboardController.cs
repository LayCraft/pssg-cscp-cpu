...
namespace Gov.Cscp.VictimServices.Public.Controllers
{
	...
	public class DashboardController : Controller
	{
		...
		public async Task<IActionResult> GetDashboard(string userBceid, string businessBceid)
		{
			try
			{
		...
		[HttpPost("Profile")]
		public async Task<IActionResult> UpdateProfile([FromBody] Models.DynamicsOrg model)
		{
