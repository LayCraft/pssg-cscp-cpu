...
namespace Gov.Cscp.Victims.Public.Controllers
{
	...
	public class DynamicsBlobController : Controller
	{
		...
		{
			DynamicsResult result = await _dynamicsResultService.GetResultAsync("vsd_GetCPUOrgContracts", "{\"BusinessBCeID\":\"fd889a40-14b2-e811-8163-480fcff4f621\",\"UserBCeID\":\"9e9b5111-51c9-e911-b80f-00505683fbf4\"}");
