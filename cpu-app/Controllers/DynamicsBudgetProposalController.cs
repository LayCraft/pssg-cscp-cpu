...
namespace Gov.Cscp.Victims.Public.Controllers
{
	...
	public class DynamicsBudgetProposalController : Controller
	{
		...
		public DynamicsBudgetProposalController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IDynamicsResultService dynamicsResultService)
		{
