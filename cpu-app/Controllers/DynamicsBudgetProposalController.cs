...
namespace Gov.Cscp.Victims.Public.Controllers
{
	...
	public class DynamicsBudgetProposalController : Controller
	{
		...
		public DynamicsBudgetProposalController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
		{
		...
		public async Task<IActionResult> SetBudgetProposal(string businessBceid, string userBceid, string contractId)
		{
			try
			{
				...
				string endpointAction = "vsd_contracts(" + contractId + ")/Microsoft.Dynamics.CRM.vsd_GetCPUBudgetProposal";
