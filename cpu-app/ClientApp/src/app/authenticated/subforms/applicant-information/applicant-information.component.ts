...
export class ApplicantInformationComponent {
    ...
    //     if (this.trans.applicantInformation.mailingAddressSameAsMainAddress) {
    //         this.trans.applicantInformation.mailingAddress = this.trans.applicantInformation.mainAddress;
    //     }
    //     else {
    //         this.trans.applicantInformation.mailingAddress = new Address();//addressCopy;
    //     }
    // }
}