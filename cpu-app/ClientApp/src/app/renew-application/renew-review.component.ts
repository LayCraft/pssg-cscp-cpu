...
@Component({
  selector: 'app-renew-review',
  templateUrl: './renew-review.component.html',
  styleUrls: ['./renew-review.component.scss'],
})

export class RenewReviewComponent extends FormBase implements OnInit {
  form: FormGroup;
