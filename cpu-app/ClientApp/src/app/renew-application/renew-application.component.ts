...
export class RenewApplicationComponent extends FormBase implements OnInit, CanDeactivateGuard {
  currentUser: User;
  dataLoaded = false;
  busy: Promise<any>;
  busy2: Promise<any>;
  ...
  getFormGroupName(groupIndex: any) {
    let elements: Array<string> = ['overview', 'contactInformation', 'administrativeInformation', 'medicalInformation', 'expenseInformation', 'employmentIncomeInformation', 'representativeInformation', 'declarationInformation', 'authorizationInformation'];
